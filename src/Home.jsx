...
function Home(){
    return(
        ...
        <div className='outer'>
        <div className='bx'>
        <svg fill="white" strokeWidth='0.3px' width="70px" height="70px" viewBox="0 0 36 36" version="1.1"  preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <rect x="0" y="0" width="36" height="36" fill-opacity="0"/>
             ...
             <h2 className='h'>Drag and Drop Image</h2>
             <h2 className='h'>Or</h2>
            <button className='b'>
